...
public:
    ...
    void draw(int width, int height, float lineScale = 10, int res = 10, float threshold = 1);
    void drawColored(int width, int height, float lineScale = 10, int res = 10, float threshold = 1);
